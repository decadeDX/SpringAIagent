...
| 401 | `SESSION_INVALIDATED` | 40101 | Redis 中的活动会话已释放、过期或不匹配，客户端应清理本地登录状态。 |
...
| 409 | `ACCOUNT_ALREADY_LOGGED_IN` | 40905 | 账号已有未过期活动会话，必须先在原设备退出。 |
...
| 503 | `REDIS_UNAVAILABLE` | 50301 | Redis 不可用，草案、首次确认或单账号会话无法安全执行。 |
